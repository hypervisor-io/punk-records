-- Punk Records core schema (Postgres dialect). Timestamps are fixed-width
-- RFC3339 UTC TEXT (store.TimeToDB) on both engines; they sort correctly.
...
CREATE INDEX idx_memories_tsv ON memories USING GIN (body_tsv);
...
CREATE TABLE tasks (
    ...
    budget_tool_calls BIGINT NOT NULL DEFAULT 0,
    budget_wall_ms BIGINT NOT NULL DEFAULT 0,
    budget_subagents BIGINT NOT NULL DEFAULT 0,
